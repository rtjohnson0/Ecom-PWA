                ...
                <main role="main">
                    ...
                    <section class="jumbotron text-center">
                        <div class="container">
                            ...
                            <p class="lead text-black">If a game is scheduled for release far in the future, the vendor may not even give us a date. In those cases, we rely on the collective wisdom of our buying staff to estimate a date based on their knowledge of the industry and the vendor's
